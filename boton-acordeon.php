...
<body>
				...
				<div id="agregar" class="panel-collapse collapse in">
					<div class="panel-body">
						<form id="formulario">
							...
							<button type="button" id="BotonGuardar" data-loading-text="Guardando..." class="btn btn-primary" autocomplete="off">Guardar</button>
						</form>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-info">
				...
				<div id="buscar" class="panel-collapse collapse">
					<div class="panel-body">						
						...
						<button type="button" id="buscar" data-loading-text="Buscando..." class="btn btn-success" autocomplete="off">Buscar</button>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-danger">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="collapsed" data-toggle="collapse" href="#eliminar" aria-expanded="false">
							<span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Eliminar usuario
						</a>
					</h4>
				</div>
				...
				<div id="eliminar" class="panel-collapse collapse">
					<div class="panel-body">						
						...
						<button type="button" id="buscar" data-loading-text="Eliminando..." class="btn btn-danger" autocomplete="off">Eliminar</button>
					</div>
				</div>
			</div>
		</div>
	...
	<br><br><br>
	<a href="tooltip-popover.php">Anterior ejemplo | </a>
	<a href="carousel.php">Siguiente ejemplo</a>
