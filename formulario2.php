...
<body>
		...
		<div class="row">
			...
			<form class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input class="form-control" type="text" id="formGroup" value="Daniel" disabled>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" id="formGroup" placeholder="Digita tu nombre">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-3">
						<span class="input-group-addon"><span class="glyphicon-phone"></span></span>
						<input class="form-control" type="text" id="formGroup">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" id="formGroup">
						<spanclass="help-block">Este nombre será mostrado a los usuarios, ocultando el verdadero</span>
					</div>
				</div>
	...
	<br><br><br>
	<a href="login.php">Anterior ejemplo | </a>
	<a href="navbar.php">Siguiente ejemplo</a>
