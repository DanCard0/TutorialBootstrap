...
<head>
	<meta charset="UTF-8">
	<title>Mi portafolio - proyecto final</title>
...
<!-- Navegación -->
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Pablo Alcántara</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-heading">Soy Pablo Alcántara</div>
                <a href="#about" class="page-scroll btn btn-xl">Saver más de mi</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="team-member">
                        <img src="img/yo/2.jpg" class="img-responsive img-circle" alt="">
                        <h4>Pablo Alcantará</h4>
                ...
                <div class="col-lg-4 col-lg-offset-2">
                    <p>
                        Soy director de arte y diseñador freelance con sede en .... En mi trayectoria profesional, que ya cuenta con más de diez años de experiencia, he sido supervisor creativo en ... y he trabajado para grandes cuentas como ....
                    </p>
                </div>
                <div class="col-lg-4">
                    <p>En los últimos años he orientado mi trabajo hacia el mundo online: dirección de arte y diseño de sitios web, aplicaciones para móviles, Facebook Apps, campañas de banners, diseño de interfaz.</p>
                </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; tu sitio web 2014</span>
                </div>
                <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered" src="img/portafolio/startup-framework-preview.png" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <h2>Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered" src="img/portafolio/treehouse-preview.png" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Start Bootstrap's Agency theme is based on Golden, a free PSD website template built by <a href="#">Mathavan Jaya</a>. Golden is a modern and clean one page web template that was made exclusively for Best PSD Freebies. This template has a great portfolio, timeline, and meet your team sections that can be easily modified to fit your needs.</p>
                            <p>You can download the PSD template in this portfolio sample item at <a href="#">FreebiesXpress.com</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <h2>Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered" src="img/portafolio/escape-preview.png" alt="">
                            <p>Escape is a free PSD web template built by <a href="#">Mathavan Jaya</a>. Escape is a one page web template that was designed with agencies in mind. This template is ideal for those looking for a simple one page solution to describe your business and offer your services.</p>
                            <p>You can download the PSD template in this portfolio sample item at <a href="#">FreebiesXpress.com</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
    ...
    <br><br><br>
    <a href="htc-desire-620-dual-sim.php">Anterior ejemplo</a>
    <a href="hola.php"> | Ejemplo inicial</a>
